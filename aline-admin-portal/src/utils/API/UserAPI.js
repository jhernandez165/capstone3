...
const UserAPI = {
    ...
    login: async function(credentials) {
        try {
            ...
            if (res.status === 200) {
                let token = res.headers['authorization'] || res.headers['Authorization'];
            ...
            console.error("Full error:", e); // Log the full error object for debugging
            if (e.response) {
            ...
            return new Error('Oops! We\'re checking what the problem is.');
        }
    },
